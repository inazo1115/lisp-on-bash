...
eq 'parse 5' '1' $(parse '1')
eq 'parse 6' '1' $(parse '(echo 1)')
eq 'parse 7' '3' $(parse '(add 1 2)')
eq 'parse 8' '8' $(parse '(add (sub 10 8) (mul 2 3))')
eq 'parse 9' '2' $(parse '(div (echo 10) 5)')
eq 'parse 10' '2' $(parse '((echo div) (echo 10) 5)')
eq 'parse 11' '55' $(parse '(add (seq 1 10))')
eq 'parse 12' 'test_lisp_on_bash.sh' $(parse '(ls test_lisp_on_bash.sh)')
